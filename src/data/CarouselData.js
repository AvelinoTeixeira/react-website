export const data = [
	{
		...
		description:
			'Nossos clientes ficam felizes com nossos serviços há vários anos. Veja avaliações reais de nossos clientes.',
	...
	{
		title: 'Nosso time',
		description: 'Nossa equipe é formada pelos melhores especialistas do setor, conheça-os',
		image: './assets/teamwork.jpg',
	},
	{
		title: 'Nossos servidores',
		description: 'Saiba mais sobre hardware e software usados ​​em seu serviço',
	...
	{
		title: 'Nossos principais clientes',
		description: 'Fornecemos serviços aos principais clientes da indústria de tecnologia',
